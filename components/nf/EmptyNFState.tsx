...
type EmptyNFStateProps = {
  onAddClick: () => void
}

export function EmptyNFState({ onAddClick }: EmptyNFStateProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        >
          <Receipt className="w-9 h-9 text-[#FF6500]" strokeWidth={1.5} />
        </div>
        {/* Glow */}
        <div
      ...
      <h3 className="text-lg font-bold text-white mb-2">Nenhuma NF adicionada</h3>
      <p className="text-sm text-[#555555] mb-8 leading-relaxed max-w-[240px]">
        Adicione notas fiscais em PDF para manter tudo organizado neste projeto
      </p>
